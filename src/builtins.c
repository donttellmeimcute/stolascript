...
StolaValue *stola_ws_connect(StolaValue *u) { (void)u; return stola_new_int(-1); }
StolaValue *stola_ws_send(StolaValue *h, StolaValue *m) { (void)h; (void)m; return stola_new_int(-1); }
StolaValue *stola_ws_receive(StolaValue *h) { (void)h; return stola_new_null(); }
StolaValue *stola_ws_close(StolaValue *h) { (void)h; return stola_new_null(); }
StolaValue *stola_ws_server_create(StolaValue *p) { (void)p; return stola_new_int(-1); }
StolaValue *stola_ws_server_accept(StolaValue *s) { (void)s; return stola_new_int(-1); }
StolaValue *stola_ws_server_close(StolaValue *s) { (void)s; return stola_new_null(); }
